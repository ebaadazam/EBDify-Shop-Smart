...
import com.ecommerce.ebdify.models.entities.CartItem;
import com.ecommerce.ebdify.models.entities.Product;
import com.ecommerce.ebdify.repository.CartItemRepository;
...
import com.ecommerce.ebdify.util.AuthUtil;
...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if (newQuantity == 0){
            ...
            double updatedPrice = cart.getTotalPrice() + (cartItem.getProductPrice() * quantity);
            cart.setTotalPrice(Math.round(updatedPrice * 10.0) / 10.0);
            cartRepository.save(cart);
        }
    ...
    public String createOrUpdateCartWithItems(List<CartItemDTO> cartItems) {
        ...
        // Check if cart exists and if not create one
        ...
        Product product = productRepository.findById(productId)
                .orElseThrow(() -> new ResourceNotFoundException("Product", "productId", finalProductId));
